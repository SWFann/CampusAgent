...
- 运行 `conda run -n CampusAgent python scripts/demo/run_demo_smoke.py`：✅ 11 passed, 0 failed
...
- `conda run -n CampusAgent python scripts/release/check_release_candidate.py`：✅ 5 passed, 1 failed（仅 P13-COMPLETION-REPORT.md 缺失，现已创建）
- `conda run -n CampusAgent python scripts/release/collect_evidence.py`：✅ 证据收集成功
